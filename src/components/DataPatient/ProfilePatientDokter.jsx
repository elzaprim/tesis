  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setError("Gagal mengambil data pasien atau data tambahan.");
      } finally {
        setLoading(false);
      }
    };
...
export default ProfilePatientDokter;
